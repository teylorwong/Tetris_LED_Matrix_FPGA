...
module etch_a_sketch (
    ...
    encoder encoder_1 (.clk(clk), .a(enc1_a), .b(enc1_b),.cw(enc1_cw), .ccw(enc1_ccw));
    
    encoder encoder_2 (.clk(clk), .a(enc2_a), .b(enc2_b),.cw(enc2_cw), .ccw(enc2_ccw));
