...
always_ff @(posedge clk or negedge reset_n) begin
    if (!reset_n) begin
        ...
        // Restore the previous pixel color before moving
        input_matrix[cursor_pos] <= 3'b111;  // Restore drawn pixel (White)
        ...
        // Temporarily highlight cursor position with blue
        input_matrix[cursor_pos] <= 3'b001;  // Cursor indicator (Blue)
    end
end
